...
•	Perhitungan Utama:
o	Rata-Rata Jual: $R = \text{Penjualan Harian/Bulanan Rata-Rata}$.
o	Safety Stock (Stok Aman): $SS = R \times \text{Safety Stock Factor}$.
o	Reorder Point (Titik Pemesanan Ulang): $RP = R \times \text{Reorder Point Factor}$.
•	Rekomendasi:
o	Jika $\text{Stok Saat Ini} \le SS$, maka Stok Kritis!
o	Jika $SS < \text{Stok Saat Ini} \le RP$, maka Waktunya Pesan Ulang.
o	Jika $\text{Stok Saat Ini} > RP$, maka Stok Aman.
C. Rute Aplikasi
Rute	Metode	Tujuan
